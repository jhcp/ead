...
SegmentDisplay.prototype.setSegmentValue = function(value) {
  ...
  switch (mask) {
    case '#':
      ...
      if (this.segmentCount == 16) {
        ...
        var x = xPos;
        var y = 0;
        var charSet7 = '02356789acefp';
        if (this.value == '!') {
          charSet7 = 0;
        }
        context.fillStyle = this.getSegmentColor(c, charSet7, '02356789abcdefgiopqrstz@');
        context.beginPath();
        switch (this.cornerType) {
          case SegmentDisplay.SymmetricCorner:
            context.moveTo(x + s + d, y + s);
      ...
      y = 0;
      var charSet7 = '01234789adhpy';
      if (this.value == '!') {
        charSet7 = 1;
      }
      context.fillStyle = this.getSegmentColor(c, charSet7, '01234789abdhjmnopqruwy');
      context.beginPath();
      switch (this.cornerType) {
        case SegmentDisplay.SymmetricCorner:
      ...
      var charSet7 = '013456789abdhnouy';
      if (this.value == '!') {
        charSet7 = 2;
      }
      context.fillStyle = this.getSegmentColor(c, charSet7, '01346789abdghjmnoqsuw@', '%');
      context.beginPath();
      ...
      if (this.segmentCount == 16) {
        ...
        x = xPos;
        y = this.digitHeight - this.segmentWidth;
        var charSet7 = '0235689bcdelotuy_';
        if (this.value == '!') {
          charSet7 = 3;
        }
        context.fillStyle = this.getSegmentColor(c, charSet7, '0235689bcdegijloqsuz_=@');
        context.beginPath();
        context.moveTo(x + this.segmentWidth + d, y);
        context.lineTo(x + this.digitWidth - this.segmentWidth - d, y);
        switch (this.cornerType) {
      ...
      x = xPos;
      y = h + this.segmentWidth;
      var charSet7 = '0268abcdefhlnoprtu';
      if (this.value == '!') {
        charSet7 = 4;
      }
      context.fillStyle = this.getSegmentColor(c, charSet7, '0268acefghjklmnopqruvw@');
      context.beginPath();
      context.moveTo(x, y + this.segmentWidth + d);
      context.lineTo(x + s, y + s + d);
      context.lineTo(x + this.segmentWidth, y + this.segmentWidth + d);
      ...
      x = xPos;
      y = 0;
      var charSet7 = '045689abcefhlpty';
      if (this.value == '!') {
        charSet7 = 5;
      }
      context.fillStyle = this.getSegmentColor(c, charSet7, '045689acefghklmnopqrsuvwy@', '%');
      context.beginPath();
      ...
      if (this.segmentCount == 7) {
        ...
        var charSet7 = '2345689abdefhnoprty';
        if (this.value == '!') {
          charSet7 = 6;
        }
        context.fillStyle = this.getSegmentColor(c, charSet7);
        context.beginPath();
        context.moveTo(x + s + d, y + s);
        context.lineTo(x + this.segmentWidth + d, y);
        context.lineTo(x + this.digitWidth - this.segmentWidth - d, y);
...
SegmentDisplay.prototype.getSegmentColor = function(c, charSet7, charSet14, charSet16) {
  if (c == '#') {
    ...
    if (c == '!') {
      return (this.segmentValue.charAt(charSet7) == 0) ? this.colorOff : this.colorOn;
    }
